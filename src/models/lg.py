...
df_train = pd.read_csv('/Users/petr/Development/Santander-Competition/data/train.csv.zip', usecols=usecols)
sample = pd.read_csv('/Users/petr/Development/Santander-Competition/data/sample_submission.csv.zip')
...
models = {}
model_preds = {}
id_preds = defaultdict(list) # Returns value. If no value - returns empty list
